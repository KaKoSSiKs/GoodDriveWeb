<script>
  ...
  // SEO данные - оптимизировано для регионального поиска
  const seoData = $state({
    title: 'Автозапчасти Челябинск - GoodDrive | Интернет-магазин автозапчастей',
    description: 'Автозапчасти в Челябинске от GoodDrive. Широкий ассортимент автозапчастей для всех марок автомобилей. Доставка по Челябинску и России. Оригинальные и совместимые запчасти. Быстрая доставка, гарантия качества.',
    keywords: 'автозапчасти челябинск, автозапчасти, запчасти для авто челябинск, интернет магазин автозапчастей челябинск, купить автозапчасти челябинск, доставка автозапчастей челябинск, оригинальные запчасти челябинск',
